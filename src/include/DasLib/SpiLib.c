 ...
 *****************************************************************************
   ...
   - V0.2, March 2012: comments clarifications. Correction of the SpiTxFifoFlush
                       and SpiRxFifoFlush functions. 
...
/**
	...
	@return SPIRX value
	@warning
		SPI must be configured before reading data.
**/
...
/**
	...
	@return 1 if successful 
	@warning
		SPI must be configured before writing data.
**/
