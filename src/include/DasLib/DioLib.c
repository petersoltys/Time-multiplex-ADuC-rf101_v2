 ...
 *****************************************************************************
   ...
   - V0.2, October 2012: changes in parameter type,
                       comment correction, 
...
/**
	...
	@param pPort :{pADI_GP0,pADI_GP1,pADI_GP2,pADI_GP3,pADI_GP4}
		- pADI_GP0 for GP0.
		- pADI_GP1 for GP1.
		- pADI_GP2 for GP2.
		- pADI_GP3 for GP3.
...
/**
	@brief int DioPul(ADI_GPIO_TypeDef *pPort, int iPul)
			========== Sets pull up of all pins of specified port.
	@param pPort :{pADI_GP0,pADI_GP1,pADI_GP2,pADI_GP3,pADI_GP4}
		- pADI_GP0 for GP0.
		- pADI_GP1 for GP1.
		- pADI_GP2 for GP2.
...
/**
	@brief int DioOce(ADI_GPIO_TypeDef *pPort, int iOce)
			========== Sets open collector of all pinsof specified port.
	@param pPort :{pADI_GP0,pADI_GP1,pADI_GP2,pADI_GP3,pADI_GP4}
		- pADI_GP0 for GP0.
		- pADI_GP1 for GP1.
		- pADI_GP2 for GP2.
