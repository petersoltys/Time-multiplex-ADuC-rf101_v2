...
/**
	...
	@param iConfig :{0|I2CSCON_NACK_EN|I2CSCON_EARLYTXR_EN|I2CSCON_GCSB|I2CSCON_HGC_EN|I2CSCON_GC_EN|I2CSCON_ADR10_EN|I2CSCON_SLV_EN}	\n
		- 0 by default.
		...
		- I2CSCON_GCSB to clear general call status register.
...
/**
	@brief int I2cBaud(int iHighPeriod, int iLowPeriod)
			========== Set the I2C clock rate in Master mode
