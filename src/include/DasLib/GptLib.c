 ...
 *****************************************************************************
   ...
   - V0.2, March 2012: comments clarifications.
...
/**
	...
	@param iClkSrc :{TCON_CLK_UCLK,TCON_CLK_PCLK,TCON_CLK_LFOSC,TCON_CLK_LFXTAL}
		...
		- TCON_CLK_LFOSC, the timer is clocked by internal 32kHz oscillator.
	...
	@param iScale :{TCON_PRE_DIV1,TCON_PRE_DIV16,TCON_PRE_DIV256,TCON_PRE_DIV32768}
		- TCON_PRE_DIV1 for prescale of 1 (or 4 if UCLK or PCLK chosen by iSrc).
		- TCON_PRE_DIV16 for prescale of 16.
		- TCON_PRE_DIV256 for prescale of 256.
		- TCON_PRE_DIV32768 for prescale of 32768.
	@param iMode :{TCON_MOD_PERIODIC|TCON_UP_EN|TCON_RLD_EN|TCON_ENABLE_EN|TCON_EVENT_EN}	
		- TCON_MOD_PERIODIC for the timer to run in periodic mode. TCON_MOD_FREERUN by default.
		- TCON_UP_EN for the timer to count up. TCON_UP_DIS by default.
		- TCON_RLD_EN for the timer to reload on everflow. TCON_RLD_DIS by default.
		- TCON_ENABLE_EN to enable the timer. TCON_ENABLE_DIS by default.
		- TCON_EVENTEN_EN to enable the capture mode. TCON_EVENT_DIS by default.
...
/**
	...
	@param iTCapSrc :{T0CON_EVENT_T2, T0CON_EVENT_EXT0, T0CON_EVENT_EXT1, T0CON_EVENT_EXT2, 
                          ...
                          T0CON_EVENT_EXT7, T0CON_EVENT_EXT8  T0CON_EVENT_T3,  T0CON_EVENT_HFT,
                          T0CON_EVENT_T1, T0CON_EVENT_ADC, T0CON_EVENT_FEE, T0CON_EVENT_COM,
                          T1CON_EVENT_T0, T1CON_EVENT_SPI0, T1CON_EVENT_SPI1, T1CON_EVENT_I2CS,    
                          T1CON_EVENT_I2CM, T1CON_EVENT_DMAERR, T1CON_EVENT_DMADONE, T1CON_EVENT_EXT1, 
                          T1CON_EVENT_EXT2, T1CON_EVENT_EXT3, T1CON_EVENT_PWMTRIP, T1CON_EVENT_PWM0,     
                          T1CON_EVENT_PWM1, T1CON_EVENT_PWM2, T1CON_EVENT_PWM3 }
